...
- **`references/tailwind-fundamentals.md`** - Basic utilities, layout, spacing, typography
- **`references/cn-utility-dynamic-styling.md`** - cn() utility, conditional classes, dynamic values
- **`references/responsive-dark-mode.md`** - Responsive design, dark mode, container queries

Code examples in `assets/`:
- **`assets/tailwind-complete-example.tsx`** - Complete working example with header, hero, features, footer, responsive design, dark mode
