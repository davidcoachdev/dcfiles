...
> **Extended reference**: See [assets/extended.md](assets/extended.md) for 40+ patterns and deep-dive examples
...
# use join + preload in the query itself. See [assets/extended.md](assets/extended.md) for advanced patterns.
