...
description: >
  Error analysis expert for root cause analysis, stack trace forensics, and pattern matching.
  Use when encountering any bug, test failure, or unexpected behavior, before proposing fixes.
  Trigger: When debugging errors, root cause analysis, or stack trace analysis.
license: Apache-2.0
metadata:
...
- `assets/condition-based-waiting-example.ts` - TypeScript implementation of condition-based waiting
- `assets/test-pressure-*.md` - Real-world debugging scenarios and solutions
