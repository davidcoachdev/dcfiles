...
description: >
  ...
  Trigger: When building frontend apps, React components, Vue components, Angular apps, or UI implementations.
license: Apache-2.0
metadata:
...
- Building React, Vue, Angular, or Svelte applications
- Creating UI components with modern CSS approaches
- Implementing state management (Redux, MobX, Vuex, Pinia)
