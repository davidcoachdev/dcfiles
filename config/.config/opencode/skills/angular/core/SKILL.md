...
- **`references/signals-reactive-state.md`** - Signals, computed, effects, input/output
- **`references/standalone-control-flow.md`** - Standalone components, @if/@for/@switch
- **`references/zoneless-change-detection.md`** - Zoneless Angular, OnPush, change detection

Code examples in `assets/`:
- **`assets/angular-core-complete-example.ts`** - Complete working examples with UserList, UserCard, Counter, Form, StatusDisplay components

## External Resources

- **Main Docs**: https://angular.dev
